...
if __name__ == '__main__':
	...
	df = spark.readStream.schema(schema).json("file:///home/talentum/spark-jupyter/Spark-Structured-Streaming/Spark-Structured-Streaming/source")
	...
	df.writeStream \
  	.outputMode("append") \
  	.format("parquet") \
  	.option("path", "hdfs://localhost:9000/tmp/datalake/FaresRaw") \
  	.option("checkpointLocation", "hdfs://localhost:9000/tmp/checkpoints/FaresRaw") \
